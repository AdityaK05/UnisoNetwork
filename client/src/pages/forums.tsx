...
export default function ForumsPage(): JSX.Element {
  ...
  const handlePost = async (isDraft = false) => {
    ...
    // Optimistic UI: create temporary thread to show immediately
    const tempThread: Thread = {
      ...
      authorAvatar: localStorage.getItem('userAvatar') || undefined,
                      ...
                      >
                        ...
                        <div className="relative flex items-center justify-between px-5 py-3 border-t border-primary/10 bg-white/40 backdrop-blur-lg z-10">
                          ...
                          <Button 
                            variant="ghost" 
                            size="sm" 
                            className="text-primary hover:bg-primary/10 px-3 py-1 rounded-full font-semibold"
                        ...
                        {replyingTo === thread.id && (
                          <motion.div
                            ...
                            className="px-5 py-4 bg-white/50 backdrop-blur-lg border-t border-primary/10"
                          >
                            <div className="flex gap-3">
                              ...
                              <div className="flex-1">
                                <textarea
                                  className="w-full bg-white border border-primary/20 rounded-lg px-3 py-2 resize-none focus:outline-none focus:ring-2 focus:ring-primary/30"
                                ...
                                <div className="flex items-center justify-between mt-2">
                                  <div className="text-xs text-gray-500">
                                    {(replyContent[thread.id] || '').length}/1000 characters
                                  </div>
                                  <div className="flex gap-2">
                                    ...
                                    >
                                      {submittingReply === thread.id ? 'Posting...' : 'Post Reply'}
                                    </Button>
                                  </div>
                                </div>
                              </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            ...
            >
              ...
              <div className="flex flex-col md:flex-row">
                {/* LEFT: Carousel (50%) */}
                <div
                  className={`md:w-1/2 bg-gray-50 flex flex-col items-center justify-center p-4 relative transition-colors ${
                  ...
                  >
                    ...
                    {images.length > 0 ? (
                      ...
                      <div className="w-full h-full flex flex-col items-center justify-center text-gray-400 gap-3">
                        ...
                        <div className="text-sm">Uploading images...</div>
                      </div>
                    ) : (
                      <div className="w-full h-full flex flex-col items-center justify-center text-gray-400 gap-3">
                ...
                <div className="md:w-1/2 p-6 space-y-4 flex flex-col">
                  <div>
                    ...
                    <div className="text-xs text-gray-500 mt-1 text-right">
                      {newThread.title.length}/100 characters
                    </div>
                  </div>

                  <div>
                    <textarea
                      className="w-full bg-white/60 border border-primary/10 rounded-lg px-4 py-3 h-36 resize-none focus:outline-none focus:ring-2 focus:ring-primary/30"
                  ...
                  {/* Validation messages */}
                  {newThread.title && newThread.content && !newThread.title.trim() && (
                    <div className="text-xs text-red-500">Title is required</div>
                  )}
                  {newThread.content && newThread.content.length < 10 && (
                    <div className="text-xs text-yellow-600">Content should be at least 10 characters</div>
                  )}
