...
export default function Footer() {
  const quickLinks = [
    ...
    { name: "Real Talk", href: "#testimonials" },
    { name: "Jobs", href: "#jobs" },
  ];
  ...
  return (
    <footer id="contact" className="bg-gradient-hero text-white pt-16 pb-8 relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-0 right-0 w-80 h-80 bg-secondary/10 rounded-full filter blur-3xl"></div>
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-primary/10 rounded-full filter blur-3xl"></div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            <div className="max-w-2xl mb-8 md:mb-0 md:mr-8">
              ...
              <p className="text-white/80">
                Be the first to know about exclusive events, new features, and opportunities curated for your campus. No spam, just the good stuff!
              </p>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-8">
          ...
          <div className="col-span-2 md:col-span-4">
            ...
            <p className="text-white/70 text-base mb-8">
              ...
              The ultimate social hub for college life.
            </p>
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex flex-col space-y-3">
              <a href="#" className="bg-black inline-flex items-center px-3 py-2 rounded-xl hover:bg-gray-900 transition-colors">
        ...
        <div className="mt-16 pt-8 border-t border-white/20 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center">
            <p className="text-sm text-white/60 flex items-center">
              Made with <Heart className="h-3 w-3 mx-1 text-red-400" /> by students, for students
            </p>
          </div>
        </div>
      </div>
