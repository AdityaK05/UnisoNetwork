  ...
  const features = [
    {
      ...
      description: "All your groups, events, and resources sync across all your devices."
    },
    {
      title: "Real-time notifications",
      description: "Get instant updates about events, discussions, and opportunities."
    },
    {
      title: "Offline access",
      description: "Access your study materials even without an internet connection."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-5">
            <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl font-poppins">
              UNiSO works where you do
            </h2>
            <p className="mt-4 text-lg text-gray-500">
              Available on web, iOS, and Android, UNiSO keeps you connected to your campus community anywhere, anytime.
            </p>
            ...
            <div className="mt-8 flex space-x-4">
              <a href="#" className="inline-flex items-center p-1 border border-transparent rounded-md shadow-sm text-white bg-black hover:bg-gray-800 transition-colors">
          ...
          <div className="mt-12 lg:mt-0 lg:col-span-7">
            <div className="pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
              <img 
                ...
                src="https://images.unsplash.com/photo-1498079022511-d15614cb1c02?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=600" 
                alt="Student using UNiSO on laptop" 
              />
            </div>
          </div>
        </div>
